...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.kptcp_gutenberg_blocks ) { return; }

  Object.values(window.kptcp_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'kptcp-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary kptcp-shortcode-button',
              onClick: function () {
                window.kptcp_gutenberg_props = props;
              },
            }, block.button_title ),
