 ...
 *
 */
if ( ! class_exists( 'KPF_Field_checkbox' ) ) {
  class KPF_Field_checkbox extends KPF_Fields {
    ...
    public function render() {
      ...
      $inline_class = ( $args['inline'] ) ? ' class="kpf--inline-list"' : '';
        ...
        if ( is_array( $options ) && ! empty( $options ) ) {
          ...
          foreach ( $options as $option_key => $option_value ) {
            ...
            if ( is_array( $option_value ) && ! empty( $option_value ) ) {
              ...
              echo '<li>';
                echo '<ul>';
                  ...
                  foreach ( $option_value as $sub_key => $sub_value ) {
                    ...
                    echo '<span class="kpf--text">'. esc_attr( $sub_value ) .'</span>';
                    echo '</label>';
                    echo '</li>';
                  }
                echo '</ul>';
              ...
              echo '<span class="kpf--text">'. esc_attr( $option_value ) .'</span>';
              echo '</label>';
              echo '</li>';
