 ...
 *
 */
if ( ! class_exists( 'KPTCP_Field_color' ) ) {
  class KPTCP_Field_color extends KPTCP_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="kptcp-color"'. $default_attr . $this->field_attributes() .'/>';
