 ...
 *
 */
if ( ! class_exists( 'KPF_Field_color' ) ) {
  class KPF_Field_color extends KPF_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="kpf-color"'. $default_attr . $this->field_attributes() .'/>';
